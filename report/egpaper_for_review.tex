...
\usepackage{setspace}
\usepackage{caption}
\usepackage{microtype} % makes more room
\definecolor{darkred}{rgb}{0.8,0,0}
\definecolor{darkgreen}{rgb}{0,0.6,0}
\definecolor{darkblue}{rgb}{0,0,0.6}

\usepackage[top=.8in, left=0.8in, bottom=1.1in, right=0.8in]{geometry} % slightly shrinking top margin
\usepackage[skip=3pt, font=scriptsize]{caption} % makes font smaller for image captions
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.3\textwidth]{figures/resnet_architecture.png}
