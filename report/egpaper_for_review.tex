...
\begin{table}[H]
   \begin{center}
      ...
      \end{tabular}
   \end{center}
   \caption{SNES$\rightarrow$NES Hyperparameters TODO}
   \label{tab:neshyperparameters}
\end{table}

The generator network used a 9-block ResNet architecture internally, and the discriminator network used the default basic architecture. Figure \ref{fig:unet} shows the general structure of a ResNet architecture\footnote{Adapted from \url{https://journals.plos.org/plosone/article/figure?id=10.1371/journal.pone.0249196.g006}}. The generator had $11.383 \times 10^6$ trainable parameters and the discriminator had $2.766 \times 10^6$.

\textcolor{red} {*** WE NEED TO DESCRIBE LSGAN and BASIC}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.475\textwidth]{figures/graphs/83e6736fd3e445ed9264e6d64a766939_train_graph.png}
