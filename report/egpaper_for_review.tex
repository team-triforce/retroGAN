...
The NES palette comprises 56 fixed colors, whereas the SNES is more flexible with a full 15-bit RGB palette (with 5 bits for each of the red, green and blue channels), as shown in Figures \ref{fig:nes} and \ref{fig:snes} respectively.
